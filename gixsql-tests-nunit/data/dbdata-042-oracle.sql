BEGIN
    BEGIN
        ...
        EXECUTE IMMEDIATE 'DROP TABLE bintest';
...
EXECUTE IMMEDIATE 'CREATE TABLE emptable ( eno integer, lname varchar(10), fname varchar(10), street varchar(20), city varchar(15), st varchar(2), zip varchar(5), dept varchar(4), payrate numeric(13,2), com numeric(3,2), miscdata varchar(128), dnum1 numeric(4,2), dnum2 numeric(4,2), dnum3 numeric(4,2) )';
...
EXECUTE IMMEDIATE 'INSERT INTO emptable VALUES (888, ''Smith3'', ''Jane3'', ''888, Someplace Rd.'', ''Someplace Again'', ''NA'', ''00888'', ''DEP4'', 240.00, NULL, ''aaabbb888'', 76.89, 23.45, 11.23)';
